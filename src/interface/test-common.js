...
$root.Ecommerce = (function() {
    ...
    Ecommerce.Product = (function() {
        ...
        Product.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Ecommerce.Product();
        ...
        Product.verify = function verify(message) {
            ...
            if (message.item != null && message.hasOwnProperty("item")) {
                ...
                for (var i = 0; i < message.item.length; ++i) {
                    var error = $root.Ecommerce.Item.verify(message.item[i]);
                    if (error)
                        return "item." + error;
                }
            }
        ...
        Product.fromObject = function fromObject(object) {
            if (object instanceof $root.Ecommerce.Product)
                return object;
            var message = new $root.Ecommerce.Product();
    ...
    Ecommerce.Item = (function() {
        ...
        Item.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Ecommerce.Item();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Item.fromObject = function fromObject(object) {
            if (object instanceof $root.Ecommerce.Item)
                return object;
            var message = new $root.Ecommerce.Item();
